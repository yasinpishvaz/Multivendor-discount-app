...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="product-row-title"> نمایش محصولات بر اساس دسته بندی انتخاب شده </p>
            </div>
        </div>
...
@push('scripts')
    <script>
        ...
        var childCategoryName = currentLocArr[currentLocArr.length - 1];
        var categoryName = currentLocArr[currentLocArr.length - 2];
        var cityName = currentLocArr[currentLocArr.length - 3];

        var pageNumber = 1;
        loadMore(pageNumber, categoryName, cityName, childCategoryName);
        ...
        function loadMore(pageNumber, categoryName, cityName, childCategoryName) {
            $.ajax({
                url: '/' + cityName + '/' + categoryName + '/'+ childCategoryName + '?page=' + pageNumber,
                datatype: 'html',
                type: 'get',
                beforeSend: function() {
                    $('.auto-load').show();
