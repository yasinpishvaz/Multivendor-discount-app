...
@section('title')  ویرایش حساب کاریری @endsection
...
<div class="container-fluid">
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header text-right">اطلاعات حساب کاربری</div>
                ...
                <form method="POST" action="{{route('updateprofile')}}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-left">تکرار رمز ورود</label>
                            <div class="col-md-6">
